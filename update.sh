...
wget -q -O /usr/bin/add-ip-bot "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/menu/add-ip-bot.sh" && chmod +x /usr/bin/add-ip-bot
...
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/install/speedtest_cli.py" && chmod +x /usr/bin/speedtest
